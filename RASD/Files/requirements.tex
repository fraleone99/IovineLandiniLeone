...
The \emph{DREAM} frontend is a web application that can be accessed from web browsers, mobile and
...
checks weather forecasts, privately request help, and access the forum.
\begin{figure}[H]
    \centering
...
of taking a look at the discussions and answer to them. Farmers, as agronomists, can answer to the forum threads
...
of the problem and then confirms that he wants to ask for the help of an agronomist. Victor is the agronomist responsible
...
\begin{itemize}
    \item Weather forecasts update must be done every 5 seconds.
...
\newline The highest number of simultaneous accesses is expected in the harvest period.
