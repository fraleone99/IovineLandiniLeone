...
\begin{itemize}
    \item \textbf{Registration and Login}\\
          ...
          By logging in with their account, user can access the other functions.
\end{itemize}
...
\begin{itemize}
    ...
    \newline In addition, DREAM offers the possibility to the agronomist of visualizing the best
